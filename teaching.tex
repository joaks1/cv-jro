\cvitem{6em}{Spring 2025}{
    Statistical methods in Phylogenetics and Evolutionary Genetics (BIOL 7960),
    Auburn University
}

\cvitem{6em}{Fall 2024}{
    Evolution \& Systematics (BIOL 3030),
    Auburn University
}
\cvitem{6em}{Spring 2024}{
    Herpetology (BIOL 5740/6740),
    Auburn University
}
\cvitem{6em}{Fall 2021}{
    Evolution \& Systematics (BIOL 3030),
    Auburn University
}
\cvitem{6em}{Fall 2021}{
...
\cvitem{6em}{Summer 2019}{
    Workshop on basic scripting and using version control to improve
