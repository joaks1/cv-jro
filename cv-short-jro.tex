...
\bflongcvitem{2022--present}{%
    Associate Professor \& Curator, Biological Sciences, Auburn University}{%
\begin{cellitemize}
...
\begin{cellitemize}
    \item See description above.
\end{cellitemize}}

\bflongcvitem{2022--2024}{%
    Senior Manager, Computational Biology, Adaptive Biotechnologies}{%
\begin{cellitemize}
    \item Awarded 2-year sabbatical to lead Adaptive's Statistics and
        Algorithms Team in developing statistical models and computational
        tools for inferring disease diagnoses and developing therapeutics from
        patients' genomic and transcriptomic data
\end{cellitemize}}
...
% Publications
\section*{Select Publications (\href{https://scholar.google.com/citations?user=lz3wj6AAAAAJ&hl=en}{43 total; 2,219 citations})}
...
\section*{Select Presentations (19 invited seminars and 49 conference presentations)}
...
\bflongcvitem{}{Peer review}{
    \begin{cellitemize}
        \item Participated in NSF review panel for the Division of Mathematical
            Sciences (2025)
