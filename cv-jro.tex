...
\bibitem[{Welton et~al.(Submitted)}]{Welton2014}
Welton, L.J., P.L. Wood, {\bf J.R. Oaks}, C.D. Siler, and R.M. Brown. Submitted.
\newblock Fossil-calibrated phylogeny and historical biogeography of Southeast
Asian water monitors (\emph{{V}aranus salvator} Complex).

\bibitem[{Siler et~al.(Submitted)}]{Siler2014}
Siler, C.D., {\bf J.R. Oaks}, K. Cobb, H. Ota, and R.M. Brown. Submitted.
...
P.~A. Hosner, C.~W. Linkem, A.~J. Barley, {\bf J.~R. Oaks}, M.~B. Sanguila, L.~J.
  Welton, R.~G. Moyle, A.~T. Peterson, and A.~C. Alcala. In press.
