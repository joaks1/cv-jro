...
\usepackage[bibstyle=joaks-cv,backend=biber]{biblatex}
...
\newlength{\myCVFirstCol}
\newlength{\myCVSecondCol}
\newcommand{\cvitem}[3]{
    \setlength\myCVFirstCol{#1}
    \setlength\myCVSecondCol{\textwidth}
    \addtolength{\myCVSecondCol}{-\myCVFirstCol}
    \addtolength{\myCVSecondCol}{-\tabcolsep}
    \begin{tabular}{ @{}p{\myCVFirstCol} >{\begin{minipage}[t]{\myCVSecondCol}\raggedright}l<{\end{minipage}}}
         #2 & #3
    \end{tabular}}
